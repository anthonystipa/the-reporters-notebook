...
interface Props {
	...
	let { currentSection = '', newsFeedUrl = '#feed' }: Props = $props();
    ...
    function isNewsFeedSection(currentSection: string) {
        ...
        return currentSection === '' || currentSection === 'social' || currentSection === 'layoffs' || currentSection === 'jobs'
    }
