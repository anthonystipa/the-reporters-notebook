...
import { getRecentLayoffFeedItems, sortByNewestDate } from '$lib/feed-utils';
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	const recentNewsFeedItems = getRecentLayoffFeedItems(newsFeedItems).sort(sortByNewestDate);
	return {
